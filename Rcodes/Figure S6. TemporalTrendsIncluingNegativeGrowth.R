...
for(indispecies in studySpecies){
  ...
  mainTrends$PredictedABGR <- exp(fittedvalues$fit)-15
  mainTrends$PredictedABGR_Upper <- exp(fittedvalues$fit+1.98*fittedvalues$se.fit)-15
  mainTrends$PredictedABGR_Lower <- exp(fittedvalues$fit-1.98*fittedvalues$se.fit)-15
