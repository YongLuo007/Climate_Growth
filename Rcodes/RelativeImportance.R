...
load(file.path("/home/yonluo/Climate_Growth/data/finalYearModels168plotsAllCensusPositiveTrees.RData"))
...
for(indispecies in studySpecies){
  ...
  allIDVS[Variable %in% ontogenyCompetition, Group:="Ontogeny+Competition"]
  allIDVS[Variable %in% ontogenyClimate, Group:="Ontogeny+Climate"]
  allIDVS[Variable %in% competitionClimate, Group:="Competition+Climate"]
...
newimportanceTable <- importanceTable[,.(importance=importance*100, 
                                      ...
                                      by = c("Species", "Group")]
write.csv(newimportanceTable, file.path("/home/yonluo/Climate_Growth/importanceTable.csv"), row.names = F)
...
load(file.path("/home/yonluo/Climate_Growth/relativeImportance.RData"))

ggsave(file = file.path("/home/yonluo/Climate_Growth/RelativeImportance.png"),
       importanceFigure,
       width = 9, height = 7.5)
